...
<form class="form-group" action="addSever.php" method="post" >
  ...
  <div class="form-group">
    <label for="jianjie">内容简介:50字以内</label>
		<textarea name="jianjie" id="jianjie" style="width: 100%;height: 50px;">

		</textarea>    
  </div>
   <div class="form-group">
     <label for="keyWords">关键词:","号分隔</label>
   		<textarea name="keyWords" id="keyWords" style="width: 100%;height: 26px;">
   
   		</textarea>    
   </div> 
    <div class="form-group">
    <label for="imgH">封面图片 大小为232*102</label>
