        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <li  ><a href="index.html">首页 </a></li>
                                        <li ><a href="#">优惠开户</a></li>
                                        <li class="active"><a href="newslist.php">财经十二<span class="sr-only">(current)</span></a><p class="line-top hidden-xs"></p></li>
                                        <li ><a href="xuexijinjie.html">学习进阶</a></li>
                                        <li ><a href="caijingbowen.php">财经博文</a></li>  <!--放seo文章的-->
                                        <li ><a href="#">联系我们</a></li>
	...
	<div class="row">
		<div class="col-sm-12">
			<ol class="breadcrumb" style="margin-top: 10px; margin-bottom: 10px;">
				...
				<li><a href="/www.yugyud.com/newslist.html">财经十二</a></li>			</ol>
		</div>
	</div>
</div>
